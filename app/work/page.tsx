...
const Work = () => {
  return (
    ...
    Here are some of my selected works that showcase my expertise in full-stack development.  
    Whether it's building scalable applications or crafting seamless user experiences,  
    these projects highlight my ability to blend <strong>technology, design, and performance</strong>.  
      
      I'm sure you'll find something you like!</p>



 <Link href="https://github.com/shekhar9837" target="_blank" rel="noopener noreferrer">
           <button
             type="submit"
