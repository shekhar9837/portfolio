      ...
      <div className="w-full  flex custom:flex-row flex-col justify-center custom:py-20 py-10">
        ...
        >
          <p className="custom:text-start font-poppins font-medium tracking-tight">
            Here are some of my selected works that showcase my expertise in
            full-stack development. Whether it's building scalable applications
            or crafting seamless user experiences, these projects highlight my
            ability to blend{" "}
            <strong>technology, design, and performance</strong>. I'm sure
